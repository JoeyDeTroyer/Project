...
public class FXMLAttitudeController extends BorderPane {
    ...
    public void toevoegen() {
        ...
        if ("".equals(txtToevoegen.getText())) {
            ...
            txtToevoegen.clear();
        } else if (valuesTemp.contains(txtToevoegen.getText())) {
            //error
            Alert alert = new Alert(AlertType.ERROR);
            alert.setTitle("Error");
    ...
    public void right() {
        ...
        } else if (valuesTemp.contains(listView1.getSelectionModel().getSelectedItem())) {
    ...
    public void left() {
        ...
        } else if (valuesTemp.contains(listView2.getSelectionModel().getSelectedItem())) {
