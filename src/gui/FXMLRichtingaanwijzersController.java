...
public class FXMLRichtingaanwijzersController extends BorderPane {
    ...
    public FXMLRichtingaanwijzersController(ScreenSwitcher switcher) {
        ...
        //Controle eerste groep (Gebruik)
        try {

            int getalGroep1 = Configuratie.evaluatie.getVerkeerstechniek().getRichtingsaanwijzers().getGebruik();
        ...
        //Controle tweede groep (Tijdig Gebruik)
        try {

            int getalGroep2 = Configuratie.evaluatie.getVerkeerstechniek().getRichtingsaanwijzers().getTijdigGebruik();
        ...
        try {
            ...
            int getalGroep3 = Configuratie.evaluatie.getVerkeerstechniek().getRichtingsaanwijzers().getRichtingsaanwijzersAndere();
        ...
        //CHANGELISTENERS// 
        //Controle voor Gebruik (Groep 1)
        rij1Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            @Override
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                Verkeerstechniek_Richtingsaanwijzers richtings = new Verkeerstechniek_Richtingsaanwijzers();
                if (rij1Kolom1.isSelected() == true) {
                    richtings.setGebruik(1);
                } else if (rij1Kolom2.isSelected() == true) {
                    richtings.setGebruik(2);
                } else {
                    richtings.setGebruik(3);
                }
                Configuratie.evaluatie.getVerkeerstechniek().setRichtingsaanwijzers(richtings);
            }
        });

        //Controle voor Tijdig Gebruik(Groep 2)
        rij2Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                ...
                Configuratie.evaluatie.getVerkeerstechniek().getRichtingsaanwijzers().setTijdigGebruik(getal);
            }
        });
        ...
        rij3Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                ...
                Configuratie.evaluatie.getVerkeerstechniek().getRichtingsaanwijzers().setRichtingsaanwijzersAndere(getal);
            }
        });
