...
import Models.Verkeerstechniek.Verkeerstechniek_LinksAfslaan;
...
public class FXMLLinksafController extends BorderPane
{
    ...
    public FXMLLinksafController(ScreenSwitcher switcher)
    {
        ...
        try {
            ...
            int getalGroep1 = Configuratie.evaluatie.getVerkeerstechniek().getLinksAfslaan().getOpstellingLinks();
        ...
        try {
            ...
            int getalGroep2 = Configuratie.evaluatie.getVerkeerstechniek().getLinksAfslaan().getUitvoeringLinks();
        ...
        try {
            ...
            int getalGroep3 = Configuratie.evaluatie.getVerkeerstechniek().getLinksAfslaan().getLinksAfslaanAndere();
        ...
        rij1Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                Verkeerstechniek_LinksAfslaan links = new Verkeerstechniek_LinksAfslaan();
                if (rij1Kolom1.isSelected() == true) {
                    links.setOpstellingLinks(1);
                } else if (rij1Kolom2.isSelected() == true) {
                    links.setOpstellingLinks(2);
                } else {
                    links.setOpstellingLinks(3);
                }
                Configuratie.evaluatie.getVerkeerstechniek().setLinksAfslaan(links);
            }
        });
        ...
        rij2Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                ...
                Configuratie.evaluatie.getVerkeerstechniek().getLinksAfslaan().setUitvoeringLinks(getal);
            }
        });
