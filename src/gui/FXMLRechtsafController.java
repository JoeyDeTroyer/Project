...
public class FXMLRechtsafController extends BorderPane {
    ...
    public FXMLRechtsafController(ScreenSwitcher switcher) {
        ...
        try {
            ...
            int getalGroep1 = Configuratie.evaluatie.getVerkeerstechniek().getRechtsAfslaan().getOpstellingRechts();
        ...
        try {
            ...
            int getalGroep2 = Configuratie.evaluatie.getVerkeerstechniek().getRechtsAfslaan().getUitvoeringRechts();
        ...
        try {
            ...
            int getalGroep3 = Configuratie.evaluatie.getVerkeerstechniek().getRechtsAfslaan().getRechtsAfslaanAndere();
        ...
        rij1Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                Verkeerstechniek_RechtsAfslaan rechts = new Verkeerstechniek_RechtsAfslaan();
                if (rij1Kolom1.isSelected() == true) {
                    rechts.setOpstellingRechts(1);
                } else if (rij1Kolom2.isSelected() == true) {
                    rechts.setOpstellingRechts(2);
                } else {
                    rechts.setOpstellingRechts(3);
                }
                Configuratie.evaluatie.getVerkeerstechniek().setRechtsAfslaan(rechts);
            }
        });
        ...
        rij2Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                ...
                Configuratie.evaluatie.getVerkeerstechniek().getRechtsAfslaan().setUitvoeringRechts(getal);
            }
        });
        ...
        rij3Groep.selectedToggleProperty().addListener(new ChangeListener<Toggle>() {
            ...
            public void changed(ObservableValue<? extends Toggle> ov, Toggle old_toggle, Toggle new_toggle) {
                ...
                Configuratie.evaluatie.getVerkeerstechniek().getRechtsAfslaan().setRechtsAfslaanAndere(getal);
            }
        });
    }
